...
NAME = "Data Accuracy Checker"


class CategoricalAccuracyChecker(BaseModel):
    """Categorical accuracy checker"""

    column_name: str
    column_type: str
    accuracy_check_results: str


class NumericalAccuracyChecker(BaseModel):
    """Numerical accuracy checker"""

    column_name: str
    column_type: str
    accuracy_check_results: list[str]


class DataAccuracyCheckerAgent(Agent):
