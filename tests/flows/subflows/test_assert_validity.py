...
from tests.flows.subflows.validation_cases.utils import load_all_test_cases, ValidationTestCase
...
@pytest.mark.parametrize("test_case_data", load_all_test_cases(), ids=lambda case: case.case_name)
